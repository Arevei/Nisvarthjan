...
const fallbackHindi: Record<string, string> = {
  ...
  "Your details are saved.": "आपके विवरण सुरक्षित हैं।",
  "Payment": "भुगतान",
  "Complete membership fee.": "सदस्यता शुल्क पूरा करें।",
  "Admin approval": "एडमिन अनुमोदन",
  "Foundation team activation.": "फाउंडेशन टीम द्वारा सक्रियण।",
  "Issued after activation.": "सक्रियण के बाद जारी किया जाएगा।",
  "Done": "पूर्ण",
  "Next step": "अगला कदम",
  "Remaining": "शेष",
  "Membership active": "सदस्यता सक्रिय",
  "Membership active, certificate pending": "सदस्यता सक्रिय, प्रमाणपत्र लंबित",
  "Your membership is complete. You can download your documents below.": "आपकी सदस्यता पूर्ण हो गई है। आप अपने दस्तावेज़ नीचे डाउनलोड कर सकते हैं।",
  "Your membership is active. The certificate will appear here after it is issued by the foundation team.": "आपकी सदस्यता सक्रिय है। फाउंडेशन टीम द्वारा जारी किए जाने के बाद प्रमाणपत्र यहां दिखाई देगा।",
  "Payment pending": "भुगतान लंबित",
  "Your membership is approved. Please complete the payment step shared by the foundation team.": "आपकी सदस्यता स्वीकृत है। कृपया फाउंडेशन टीम द्वारा साझा किए गए भुगतान चरण को पूरा करें।",
  "Admin approval pending": "एडमिन अनुमोदन लंबित",
  "Your payment is confirmed. The foundation team will activate your account and email your certificate and ID card after approval.": "आपके भुगतान की पुष्टि हो गई है। अनुमोदन के बाद फाउंडेशन टीम आपके खाते को सक्रिय करेगी और आपका प्रमाणपत्र और आईडी कार्ड ईमेल करेगी।",
