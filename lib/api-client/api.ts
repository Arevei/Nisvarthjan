...
/**
 * @summary Update member status or type
 */
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { memberId: number; data: BodyType<UpdateMemberInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { campaignId: number; data: BodyType<UpdateCampaignInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
/**
 * @summary Issue or regenerate certificate for a member
 */
export const getIssueCertificateUrl = (memberId: number) => {
  return `/api/admin/certificates/${memberId}`;
};
...
export const issueCertificate = async (
  ...
  return customFetch<IssueCertificateResponse>(
    getIssueCertificateUrl(memberId),
    {
      ...options,
      method: "POST",
    },
...
> => {
  ...
  > = (props) => {
    ...
    return issueCertificate(memberId, requestOptions);
  };
...
export type IssueCertificateMutationError = ErrorType<void>;
...
export const listContacts = async (
  ...
  return customFetch<ContactMessage[]>(getListContactsUrl(), {
    ...options,
    method: "GET",
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: number; data: BodyType<NewsArticleInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type UpdateNewsArticleMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateNewsArticle>>
>;
export type UpdateNewsArticleMutationBody = BodyType<NewsArticleInput>;
