      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="prose max-w-none text-foreground space-y-6">
          {[
            ...
            { h: t("5. Contact Us", "5. हमसे संपर्क करें"), p: t("If you have any questions about this Privacy Policy, please contact us at privacy@nisvarthjan.org.", "यदि इस गोपनीयता नीति के बारे में आपके कोई प्रश्न हैं, तो कृपया privacy@nisvarthjan.org पर हमसे संपर्क करें।") },
          ].map(({ h, p }) => (
            <section key={h}>
